...
export const level1: LevelConfig = {
  ...
  interactiveObjects: [
    ...
    },
    {
      ...
      area: { x: 25, y: 43, width: 80, height: 80 },
      unlockAfter: 'molino',
      activityId: 'activity-03',
      visual: {
        resource: '/assets/level1/river.png',
        transform: 'perspective(1100px) rotateZ(-4.5deg) skewX(-0.3deg)',
        transformOrigin: 'center center',
        fit: 'fill',
        zIndex: 1,
        className: INTERACTIVE_OBJECT_STYLES.hoverDefault ,
    ...
    },
    {
      ...
      area: { x: 55, y: 31, width: 17, height: 40 },
      unlockAfter: 'robot',
      activityId: 'activity-05',
      visual: {
        resource: '/assets/level1/terminal.png',
        transform: 'perspective(1000px) rotateY(-20deg) rotateZ(2deg) skewY(0.2deg)',
        transformOrigin: 'center center',
        className: INTERACTIVE_OBJECT_STYLES.hoverDefault,
        fit: 'cover',
      },
    },
    {
      ...
      area: { x: 64, y: 11, width: 40, height: 50 },
      unlockAfter: 'terminal',
      activityId: 'activity-06',
      visual: {
        resource: '/assets/level1/door.png',
        transform: 'perspective(1000px) rotateY(-22deg) rotateZ(-2deg) skewX(0deg)',
        transformOrigin: 'center center',
        className: INTERACTIVE_OBJECT_STYLES.hoverDefault,
        fit: 'cover',
      },
